...
const getFeatures = (t: (key: string) => string) => [
  {
    title: t('primary.feature1.title'),
    description: t('primary.feature1.description'),
    image: screenshotPayroll,
  },
  {
    title: t('primary.feature2.title'),
    description: t('primary.feature2.description'),
    image: screenshotExpenses,
  },
  {
    title: t('primary.feature3.title'),
    description: t('primary.feature3.description'),
    image: screenshotVatReturns,
  },
  {
    title: t('primary.feature4.title'),
    description: t('primary.feature4.description'),
