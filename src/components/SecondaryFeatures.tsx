...
const getFeatures = (t: (key: string) => string): Array<Feature> => [
  {
    name: t('secondary.feature1.title'),
    summary: t('secondary.feature1.summary'),
    description: t('secondary.feature1.description'),
  ...
  {
    name: t('secondary.feature2.title'),
    summary: t('secondary.feature2.summary'),
    description: t('secondary.feature2.description'),
  ...
  {
    name: t('secondary.feature3.title'),
    summary: t('secondary.feature3.summary'),
    description: t('secondary.feature3.description'),
...
function FeaturesMobile({ features }: { features: Array<Feature> }) {
  return (
...
function FeaturesDesktop({ features }: { features: Array<Feature> }) {
  return (
