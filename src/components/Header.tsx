          ...
          <div className="flex items-center gap-x-5 md:gap-x-8">
            <div className="hidden md:flex items-center gap-x-2">
              <button 
                ...
                className={clsx(
                  "text-sm font-semibold hover:text-blue-600",
                  language === 'nl' ? 'text-slate-900' : 'text-slate-500'
                )}
              >
                NL
              </button>
              ...
              <button 
                ...
                className={clsx(
                  "text-sm font-semibold hover:text-blue-600",
                  language === 'en' ? 'text-slate-900' : 'text-slate-500'
                )}
              >
                EN
              </button>
            </div>
            <Button href="#" color="blue" className="hidden md:inline-flex">
              <span>
                {t('hero.button')} <span className="hidden lg:inline"></span>
              </span>
            </Button>
